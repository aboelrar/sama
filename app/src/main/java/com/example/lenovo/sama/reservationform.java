...
public class reservationform extends AppCompatActivity {
    ...
    public void navigationselect() {
        ...
        nearest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(reservationform.this, mapactivity.class));
            }
        });
        ...
        flight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(reservationform.this, samatrips.class));
...
contactus.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View v) {
        startActivity(new Intent(reservationform.this, com.example.lenovo.sama.view.contactus.class));
    }
});
        ...
        editData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(reservationform.this,EditData.class));
    ...
    public void getexpandableData() {
        ...
        RecyclerView.Adapter adapterr = new expandAdpter(mylsits, reservationform.this);
        ...
        peopleNum.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position==0)
                {
                    ...
                    Toast.makeText(reservationform.this, item, Toast.LENGTH_SHORT).show();
